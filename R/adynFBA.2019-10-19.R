...
#'
#' s_curve takes convenient parametes and generates a sigmoid curve that
...
#
# Note that package pracma has a two parameter sigmoid function
# sigmoid(x, a, b) that implements the formula y = 1/(1+e^[-a(x-b)])
# whic is a solution to the ODE y' = y(1-y)
#
# Similarly, tropFishR contains a VBGF Von Bertalanffy Growth Function.
#
...
#' loadDynamicRates
#'
#' loadDynamicRates() reads from a file the changes to reaction rates to use
